...
<title>Cycle User Management</title>
...
<button class="btn" style="width:100%; align-items: center; justify-content:center; margin:0%; "> 
      <a href="../index.php" style="color:black; border: redius 10px; text-decoration:none"> <h1>Go to Main Page </h1> </a> 
    </button>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
                        <h2>Cycle Rental <b>User Management</b></h2>
                    </div>
